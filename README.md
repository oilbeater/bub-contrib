...
| [`packages/bub-eye`](./packages/bub-eye/README.md)                                   | `eye`                  | Background screen recorder (Intel Mac v1). Runs ffmpeg under a watchdog, rotates video segments, and appends one event per segment to an independent visual tape. |
